 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="index.html"><img height="70" width="35" src="{{ URL::asset('assets/images/university.png') }}" alt=""> </a>
            ...
            <ul class="nav navbar-nav ml-auto">
                <div class="btn-group mb-1 nav-item dropdown">
                  <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    @if (App::getLocale() == 'ar')
                    {{ 'العربية' }}
                   <img src="{{ URL::asset('assets/images/flags/SYR.png') }}" alt="">
                    @else
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="#"><i class="text-danger ti-unlock"></i><form method="POST" action="{{ route('logout') }}">
                            @csrf
