                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    ...
                                    <h4>{{ \App\Models\College::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i>
                                <a class="btn btn-primary" href="{{ url('college') }}">Show</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-bookmark-o mr-1" aria-hidden="true"></i>
                                <a class="btn btn-primary" href="{{ url('teacher') }}">Show</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-calendar mr-1" aria-hidden="true"></i>
                                <a class="btn btn-primary" href="{{ route('student.show', 1) }}">Show</a>
                            </p>
                        </div>
                    </div>
                </div>
